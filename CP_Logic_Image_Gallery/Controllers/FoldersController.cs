...
namespace CP_Logic_Image_Gallery.Controllers
{
    public class FoldersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Parent_Id,User_Id,Date,Enabled,Description")] Folder folder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Parent_Id,User_Id,Date,Enabled,Description")] Folder folder)
        {
            if (id != folder.Id)
            {
                return NotFound();
